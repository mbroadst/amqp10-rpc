 ...
 */
RpcClient.prototype.call = function(method, params, options) {
  ...
  if (!!params)
    request.body.params = Array.isArray(params) ? params :
      u.isPlainObject(params) ? params : [ params ];
 ...
 * @param params    parameters to call the method with remotely
 */
RpcClient.prototype.notify = function(method, params, options) {
